...
class IssueProcessingWorkflow(Workflow):
    ...
    async def execute(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        async def _execute_impl():
            ...
            workflow_system = await self._create_workflow_system()
    ...
    async def _create_workflow_system(self) -> ComposableWorkflows:
        ...
        return ComposableWorkflows(
            llm_reasoning=self.service_manager.llama_reasoning._client,
            llm_code=self.service_manager.llama_code._client,
