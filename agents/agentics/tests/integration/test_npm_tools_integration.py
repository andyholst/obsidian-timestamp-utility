...
class TestPhase4NpmToolsIntegration:
    ...
    def test_npm_tools_tool_executor_multiple_calls(self):
        ...
        tool_calls = [
            {"name": "npm_search_tool", "args": {"package_name": "lodash", "limit": 3}},
            {"name": "npm_list_tool", "args": {"depth": 0}}
        ]
    ...
    def test_parametrized_npm_search(self, package_name, expected_min_results):
        ...
        tool_calls = [
            {"name": "npm_search_tool", "args": {"package_name": package_name, "limit": 5}}
        ]
