...
class TestConfigurationIntegration:
    ...
    async def test_service_setup_and_dependency_injection_with_real_configurations(
        ...
        # Verify LLM clients are initialized with custom config
        assert service_manager.llm_reasoning is not None
        assert service_manager.llm_code is not None

        # Verify LLM configurations match custom config
        reasoning_config = service_manager.llm_reasoning.config
        code_config = service_manager.llm_code.config
    ...
    async def test_configuration_with_service_dependency_injection(
        ...
        # LLM clients should be initialized with config values
        reasoning_llm_config = service_manager.llm_reasoning.config
        code_llm_config = service_manager.llm_code.config
